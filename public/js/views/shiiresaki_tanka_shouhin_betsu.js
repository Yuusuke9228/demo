...
$(function () {
    $('.tanka')
        ...
        .focusout(function (e) {
            ...
            var shiiresaki_mr_cd = $('#cd' + id_count).text();
 ...
 * 仕入先編集画面へ遷移
 */
$('.shiiresaki_mr_cd').click(function () {
    var id = $(this).attr("id");
    var id_count = id.replace(/[^0-9]/g, '');
    var shiiresaki_id = $('#shiiresaki_id' + id_count).val();

    window.open(shiiresaki_edit + '/' + shiiresaki_id, "_blank");
});
...
$('#dl-xlsx').on('click', function () {
    ...
    saveAs(blob, 'ShouhinBetsu_ShiireTankalist.xlsx');
    return false;
});
