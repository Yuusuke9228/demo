...
class ZaikoKakuninTbl extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->setSchema("smm");
        $this->setSource("zaiko_kakunin_tbl");
    }
     ...
     * @return ZaikoKakuninTbl[]|ZaikoKakuninTbl|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return ZaikoKakuninTbl|\Phalcon\Mvc\Model\ResultInterface
     */
